...
namespace Estimate.Infra.Migrations
{
    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductInEstimate",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductId = table.Column<Guid>(type: "uuid", nullable: false),
                    EstimateId = table.Column<Guid>(type: "uuid", nullable: false),
                    Price_Quantity = table.Column<double>(type: "double precision", nullable: false),
                    Price_UnitPrice = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInEstimate", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estimate_SupplierId",
                table: "Estimate",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInEstimate_EstimateId",
                table: "ProductInEstimate",
                column: "EstimateId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInEstimate_ProductId",
                table: "ProductInEstimate",
                column: "ProductId");
        }
